...
if __name__ == "__main__":
    ...
    dataset = utils.get_score(train, interactions, es_table, as_table, pca, None, mode='training')
    ...
    baseline_metrics, _, fh = utils.get_score(
        test, interactions, es_table, as_table, pca, utils.get_formula_baseline(), mode='evaluation')
