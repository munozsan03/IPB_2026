...
if __name__ == "__main__":
    ...
    for iteration in tqdm(iterations):
        for depth in tqdm(depths):
            ...
            ranker.save_model(f'/raid/data/smunoz/catnip/research_code/for_backend/scoring_formula_{iteration}_{depth}.cb')
    ...
    all_metrics.to_csv('/raid/data/smunoz/catnip/final_plots/metrics.csv', index=False)
